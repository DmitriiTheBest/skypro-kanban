...
export const ContainerSigninStyled = styled.div`
  display: block;
  width: 100vw;
  min-height: 100vh;
  margin: 0 auto;
...
export const ModalFormLoginStyled = styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: center;
...
export const ModalButtonEnterStyled = styled.span`
  width: 100%;
  height: 30px;
...
export const ModalFormGroupStyled = styled.div`
  text-align: center;
